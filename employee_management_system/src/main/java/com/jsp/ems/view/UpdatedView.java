	...
	public static void main(String[] args) {
		do {
			...
			case 1:
				...
				System.out.print("Enter perticular Operation to perform : ");
				int UserInput1 = myInput.nextInt();
				myInput.nextLine();
				switch (UserInput1) {
				case 1:
				...
				case 4:
					...
					if (employee3 != null) {
						if (controller.removeEmployee(removeEmp)) {
			...
			case 2:
				System.out.println(
						"1.Add Department\n2.View Department\n3.Update Department\n4.Remove Department\n5.Fetch all Department");
				System.out.print("Enter perticular Operation to perform : ");
				int UserInput2 = myInput.nextInt();
				myInput.nextLine();
				switch (UserInput2) {
				case 1:
				...
				case 3:
					...
					break;
				case 4:
					System.out.println("This operation does not available yet");
					break;
				case 5:
			...
			case 3:
				System.out.println(
						"1.Add Project\n2.View Project\n3.Update Project\n4.Remove Project\n5.Fetch all Project");
				System.out.print("Enter perticular Operation to perform : ");
				int UserInput3 = myInput.nextInt();
				myInput.nextLine();
				switch (UserInput3) {
				case 1:
				...
				case 3:
					...
					break;
				case 4:
					System.out.println("This operation does not available now");
					break;
				case 5:
					System.out.println("Fetch all the project");
					List<Project> allProject = controller.fetchAllProject();
					for (Project project1 : allProject) {
